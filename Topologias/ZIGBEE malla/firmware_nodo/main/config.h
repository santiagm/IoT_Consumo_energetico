 ...
 * Mantener idéntico en el Gateway.
 * Valor de laboratorio. Cambiar por un código único en producción.
 */
 ...
 * Debe coincidir exactamente con Zigbee_Gateway_UART/main/config.h.
