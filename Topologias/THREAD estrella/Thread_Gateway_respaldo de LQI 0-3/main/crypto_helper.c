...
esp_err_t crypto_make_iv(uint16_t batch_id, const char *src_id, uint8_t iv[AES_GCM_IV_LEN])
{
    ...
    /*
     * IV AES-GCM de 12 bytes:
     * 0..3  = marca fija "THRD"
     * 4..5  = batch_id
     * 6..11 = mezcla simple del identificador del nodo
     *
     * IMPORTANTE:
     * Para tesis y comparación energética sirve mientras batch_id no se repita
     * con la misma clave AES_KEY.
     */
    iv[0] = 'T';
    iv[1] = 'H';
    iv[2] = 'R';
